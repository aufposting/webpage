        ...
        <div class="container">
            <div class="row">
                ...
                <div id="contentSection" class="col-lg-8 col-md-8 col-sm-12 col-xs-12" data-show="true">
                    ...
                    <p>
                    <div class="front-listings innr-img">
                                            <?= $thread['content']; ?>
                                            </div>
                    </p>
                    <div class="front-listings">
                     <?php   if(!empty($thread['files'])) {
        $explodeFiles = explode(',',$thread['files']);
        foreach ($explodeFiles as $fir) {
            ?>
            <span id="upfiles" class="pip">
            <a class="single_image" href="http://<?php echo Yii::$app->getRequest()->serverName; ?>/frontend/web/img/uploads/<?php echo $fir; ?>">
            <img class="imageThumb" src="http://<?php echo Yii::$app->getRequest()->serverName; ?>/frontend/web/img/uploads/<?php echo $fir; ?>" title="Image">
            </a>
            </span>
        <?php }
    }
